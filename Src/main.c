...
/* Private typedef -----------------------------------------------------------*/
/* USER CODE BEGIN PTD */
//#define CCMRAM_HEAP_SIZE  64000
//#define RAM_HEAP_SIZE    78445
//char memblock1 [RAM_HEAP_SIZE];
//__attribute__((section(".ccmram")))
//char memblock2[CCMRAM_HEAP_SIZE];
...
/* USER CODE BEGIN PD */
 ...
 // {
  	//{ ( uint8_t * ) memblock2, CCMRAM_HEAP_SIZE },// << Defines a block of 0x10000 bytes starting at address 0x80000000
  	//{ ( uint8_t * )memblock1, RAM_HEAP_SIZE }, //<< Defines a block of 0xa0000 bytes starting at address of 0x90000000
...
void StartDefaultTask(void const * argument)
{
  ...
  /* USER CODE BEGIN 5 */
	 ...
	 msg_info("\r\n Starting Main Thread...\n");
	  ...
	  osThreadDef(CLOUDNAME, &cloud_test, osPriorityNormal, 0,  ((3*1024)));
...
(int) xFreeBytesRemaning;
    printf("xfreeBytes=%d",y );
  } */
