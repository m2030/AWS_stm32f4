...
/* AWS_IOT_MQTT_HOST must be of the form 
   ...
   without the https. */
#define AWS_IOT_MQTT_HOST              "a1fsx4m82pivc1-ats.iot.us-west-2.amazonaws.com"
#define AWS_IOT_MQTT_PORT              8883

/* AWS_IOT_MQTT_CLIENT_ID must be of the form "xxxxxxxxxxxx". */
#define AWS_IOT_MQTT_CLIENT_ID         "try"

/* AWS_IOT_MY_THING_NAME must be of the form "xxxxxxxxxxxx". */
#define AWS_IOT_MY_THING_NAME          "try"
// =================================================
#define AWS_IOT_ROOT_CA_FILENAME       "AmazonRootCA1.crt"
#define AWS_IOT_CERTIFICATE_FILENAME   "ff0eeb389e-certificate.pem.crt"
#define AWS_IOT_PRIVATE_KEY_FILENAME   "ff0eeb389e-private.pem.key"
